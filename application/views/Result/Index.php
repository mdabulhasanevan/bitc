...
<div ng-controller="StudentCtrl" class="col-md-10" style="background-color: #ffffff;">
    ...
    <br/>
    <div class="row">
        <h5 style="color: red;"> To Get Proper Work Set up first:Student All Info like Name, Father Mother Name, Year, Semester, Exam Data, Passed Date, Exam Completed Date, Viva date etc from menu (Setting->Promotion) and CGPA from menu(Student Info)  </h5>
        <table ng-table="usersTable" class="table table-striped">
            <tr>
                ...
                <th> RegNo &nbsp;<a ng-click="sort_with('RegNo');"><i class="glyphicon glyphicon-sort"></i></a> </th>               
                <th>Action </th>
            </tr>
            <tr ng-repeat="x in searched = (Students| filter:search | orderBy : base :reverse) | beginning_data:(current_grid - 1) * data_limit | limitTo:data_limit">
                ...
                <td>{{x.RegNo}} </td>             
                <td>    
                     <a target="_new" class="btn btn-info" href="<?php echo base_url(); ?>Testimonial/GetACertificate/{{x.StudentID}}/"> <span class=""> With Viva</span></a>                    
                     <a target="_new" class="btn btn-info" href="<?php echo base_url(); ?>Testimonial/GetACertificateWithOutViva/{{x.StudentID}}/"> <span class=""> without viva </span></a>                    
                      <a target="_new" class="btn btn-info" href="<?php echo base_url(); ?>Testimonial/GetACertificateProtoyon/{{x.StudentID}}/"> <span class="">Portoyon </span></a>                    
