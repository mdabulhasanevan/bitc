...
<html>
    <head>
        ...
        <body ng-app="myApp">  
            ...
            <div class="row CollegName" style="padding-top: 0px; background-color: #990000" >   
                <div class="col-md-12 header1" style="text-align: center; padding-top: 0px; background-color: #990000" > 
                    ...
                    <div class="col-md-11" style="padding-top: 0px; background-color: #990000">
                        <div class="col-md-12 Affilited" style="color: #FFF;font-family: cursive; margin-bottom:0px; " class="pull-right">Affiliated with National University</div>
                        <div class="col-md-12 CollegName" style="color:#bce8f1;font-family: fantasy; text-shadow: 1px 1px 1px #000000;  margin-top:-5px; padding-top:0px;" class="pull-right">Barisal Information Technology College (BITC)</div>
                        <div class="col-md-12 moto" style="color: #ffbf00;font-family: Monospace; margin-top:-5px; padding-top:0px;" class="pull-right">Our Commitment is to provide world class Education at Minimum Cost</div>                
                    </div>
                </div>
                        ...
                        foreach ($SOS as $X) {
                            ...
                            ?>
                                    <div class = "item <?php echo $isActive; ?>">
                                        <img class="img-thumbnail" src = "<?php echo base_url(); ?>uploads/students/<?php echo $X->Photo; ?>" alt = "<?php echo $X->FullName; ?>" style = "width:100%;">
