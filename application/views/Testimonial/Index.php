...
<div ng-controller="StudentCtrl" class="col-md-10" style="background-color: #ffffff;">
    ...
    <br/>
    <div class="row">
         <h5 style="color: red;"> To Get Proper Work Set up first:Student All Info like Name, Father Mother Name and CGPA from menu(Student Info)  </h5>
        <table ng-table="usersTable" class="table table-striped">
            ...
            <tr ng-repeat="x in searched = (Students| filter:search | orderBy : base :reverse) | beginning_data:(current_grid - 1) * data_limit | limitTo:data_limit">
                ...
                <td>{{x.RegNo}} </td>             
                <td>    
                    <a target="_new" class="btn btn-info" href="<?php echo base_url(); ?>Testimonial/GetTestimonial/{{x.StudentID}}"> <span class="glyphicon glyphicon-certificate"> Testimonial</span></a>                    
<!--                    <a target="_new" class="btn btn-info" href="<?php echo base_url(); ?>Testimonial/GetACertificate/{{x.StudentID}}"> <span class="glyphicon glyphicon-certificate"> A. Certificate </span></a>                    -->
                </td>
            </tr>
        </table>
