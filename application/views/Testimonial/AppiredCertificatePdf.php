...
$title= <<<EOD
   ...
   <br><br><br><br> 
           <h1 style="font-familt:sans-serif;">Appeared Certificate</h1> 
EOD;
...
$body= <<<EOD
        ...
        is a student of <b>$Faculty$Info->MajorName </b>has completed 4th year 8th semester theoretical examination on $Info->ExamCompletedFromTo and Viva & Project Paper Defense on $Info->VivaProjectDefence from our institution under the rules and regulations of  “National University”.
         $Info->GenderStatus2 cumulative grade point average (CGPA) up to 7th semester is  $Info->LastCGPA out of 4.00 point scales.
             The final result of  $smallGender2 4 years $Info->FacultyonlyName Program will be published within $Info->ResultPublished.
        </p>
