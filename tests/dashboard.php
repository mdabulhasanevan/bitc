<div  class="col-md-8" style="background-color: #ffffff;">            
    ...
    <div class="row" >
        ...
        <div class="col-md-12" style="min-height: 300px; max-height: 600px; margin: 0px; background-color: #e9ebee; padding: 0px; overflow-y: scroll;   ">
            <!--menu-->
            <div class="col-md-12" style="background-color: #ffffff; text-align: center; padding: 5px; border: 0px solid #000; margin: 0px;">
                <!--Attendance-->
                ...
                <!--Classmates-->  
                <span style="cursor: pointer;"  ng-click="GetAllBook();" data-toggle="modal" data-target="#myBookLibraryModal"> <span class="glyphicon glyphicon-book"></span>  Book Library</span>&nbsp;&nbsp;
            ...
            <div class="modal-content" >
                ...
                <div class="modal-body" >
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li><a data-toggle="tab" href="#Request">Request List</a></li>
                        <li><a data-toggle="tab" href="#Received">Received Book</a></li>
                        <li><a data-toggle="tab" href="#Cancel">Cancel List</a></li>
                    </ul>

                    <div class="tab-content">
                        <div id="home" class="tab-pane fade in active">
                            <input type="text" class="form-control" ng-model="SearchBook">
                            <table class="table table-striped">
                                ...
                                <tr ng-repeat="Book2 in AllBook">
                                    ...
                                    <td>
                                        <button class="btn-small" ng-show="Book2.Available>0" data-toggle="modal" data-target="#RequestForBookModal" ng-click="RequestForBook(Book2)" >Request</button>
